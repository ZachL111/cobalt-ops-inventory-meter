"""Regression checks for the cobalt-ops-inventory-meter casebook."""
...
from casebook.harness import assert_expected, cobalt_ops_inventory_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_ops_inventory_meter_summary(), assert_expected())
